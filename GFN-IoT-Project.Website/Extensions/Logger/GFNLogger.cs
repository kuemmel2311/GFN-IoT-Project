namespace GFN_IoT_Project.Extensions.Logger
{
    public class GFNLogger
    {
        private static readonly Lock _lock = new(); // Lock object for thread safety.
        private static string _logFilePath = "logs/GFNLogger.logs"; // Default log file path.
